...
app.controller('showOrgsWarnCtrl', ['$scope', 'DTOptionsBuilder', 'DTColumnBuilder', '$http', 'CRUDServices', 'VISITServices', '$uibModal', function ($scope, DTOptionsBuilder, DTColumnBuilder, $http, CRUDServices, VISITServices, $uibModal) {
        $scope.selectedUnit = {};
        ...
        $('#fromDateWarn').calendarsPicker({calendar: calendar, onSelect: showFromDate});
        $('#toDateWarn').calendarsPicker({calendar: calendar, onSelect: showToDate});
