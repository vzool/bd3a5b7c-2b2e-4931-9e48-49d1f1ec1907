...
app.controller('showOrgsClosedCtrl', ['$scope', 'DTOptionsBuilder', 'DTColumnBuilder', '$http', 'CRUDServices', 'VISITServices', '$uibModal', function ($scope, DTOptionsBuilder, DTColumnBuilder, $http, CRUDServices, VISITServices, $uibModal) {
        ...
        $('#fromDateClosed').calendarsPicker({calendar: calendar, onSelect: showFromDate});
        $('#toDateClosed').calendarsPicker({calendar: calendar, onSelect: showToDate});
        ...
        $scope.map = new google.maps.Map(document.getElementById('map5'), mapOptions);
