...
app.controller('userFutureVisitsCtrl', ['$scope', 'DTOptionsBuilder', 'DTColumnBuilder', '$http', 'CRUDServices', 'VISITServices', function ($scope, DTOptionsBuilder, DTColumnBuilder, $http, CRUDServices, VISITServices) {
        $scope.selectedUser = {};
        ...
        $scope.getVisitsBeans= function () {
            ...
            CRUDServices.getData("visit/get-future-visits",{"userId":$scope.selectedUser.id}).success(function (data) {
