...
app.controller('showOrgsVioCtrl', ['$scope', 'DTOptionsBuilder', 'DTColumnBuilder', '$http', 'CRUDServices', 'VISITServices', '$uibModal', function ($scope, DTOptionsBuilder, DTColumnBuilder, $http, CRUDServices, VISITServices, $uibModal) {
        ...
        $('#fromDateVio').calendarsPicker({calendar: calendar, onSelect: showFromDate});
        $('#toDateVio').calendarsPicker({calendar: calendar, onSelect: showToDate});
